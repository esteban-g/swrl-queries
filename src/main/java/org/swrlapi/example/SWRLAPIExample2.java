...
public class SWRLAPIExample2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            IRI newIRIonto = IRI.create("");
            
            ontologyManager.createOntology(newIRIonto);
...
// Process the SQWRL result
    ...
    private static void Usage() {
        System.err.println("Usage: " + SWRLAPIExample2.class.getName() + " [ <owlFileName> ]");
        System.exit(1);
    }
}
